...
//+kubebuilder:rbac:groups=sart.terassyi.net,resources=addresspools,verbs=get;list;watch;create;update;patch;delete
...
// the AddressPool object against the actual cluster state, and then
...
func (r *AddressPoolReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&sartterassyinetv1alpha1.AddressPool{}).
		Complete(r)
}
