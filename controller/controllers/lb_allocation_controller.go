...
func (r *LBAllocationReconciler) allocate2(svc *v1.Service, pool string) ([]alloc, error) {
...
func (r *LBAllocationReconciler) assign2(ctx context.Context, svc *v1.Service) error {
	logger := log.FromContext(ctx)
