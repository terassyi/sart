...
pub const BGP_PEER_FINALIZER: &str = "bgppeer.sart.terassyi.net/finalizer";
pub const BGP_PEER_NODE_LABEL: &str = "bgppeer.sart.terassyi.net/node";
pub const PEER_GROUP_ANNOTATION: &str = "bgppeer.sart.terassyi.net/group";
