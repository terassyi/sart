...
pub(crate) const ADDRESS_BLOCK_FINALIZER: &str = "addressblock.sart.terassyi.net/finalizer";
...
pub(crate) struct AddressBlockSpec {
    pub cidr: String,
...
pub(crate) struct AddressBlockStatus {}
