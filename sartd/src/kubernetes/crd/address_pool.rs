...
pub(crate) const ADDRESS_POOL_ANNOTATION: &str = "sart.terassyi.net/addresspool";
pub(crate) const LOADBALANCER_ADDRESS_ANNOTATION: &str = "sart.terassyi.net/loadBalancerIPs";
